...
const AmazonCognitoIdentity = require('amazon-cognito-identity-js-typescript')
...
const userPool = AmazonCognitoIdentity.CognitoUserPool(cognito)

//REGISTRAR EL USUARIO
const signUpCognito=async (req:any,res:any) => {
    const {usuario,password,email} = req.body
    //AQUI SE PUEDE ENCRIPTAR
    const attributeList = [];
